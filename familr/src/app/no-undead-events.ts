...
export const noUndeadEvents: Event[] = [
    ...
    { 
      ...
      { id: 75,
        title: 'Pterafolk',
        text: 'Looming in the sky a gorup od 1d4+2 Pterafolk watch the partys every move and wait until they blunder into danger.  During the next random encounter Pterafolk attack and launch javelins at the unsuspecting players but flee if they are met with any resistance to possibly return again' ,
        monsters:true,           
        name:"Pterafolk",
            rolls:1,
            die:4,
      ...
      { id: 76,
        title: 'Rare Plants',
        text: 'The character find a number of useful rare plants determined by rolling ad6, 1:2d6 dancing monkey fruit growing on trees.  2: Menga Bush with 2d6 ounces of rare leaves, 3:1d4 ryah roots growing in the ground, 4: 4d6 sinda berries growing ona  bush, 5: wukka tree with 2d6 wukka nuts, 6: 1d6 zabou growing on a  dead tree.',
        monsters:false, 
            name:"Rare Plants",
            rolls:1,
            die:6,
      ...
      { id: 78,
        ...
        text: 'A constrictor snake attacsk a random player from the jungle.  That player is surprised un less they have a passive perception of 12 or higher',
        monsters:true, 
      ...
      { id: 80,
        ...
        text: 'A giant constrictor snake attacsk a random player from the jungle.  That player is surprised un less they have a passive perception of 12 or higher',
        monsters:true, 
      ...
      { id: 81,
        ...
        text: 'A giant poisonous snake attacks a random player from the jungle.  That player is surprised un less they have a passive perception of 14 or higher',
        monsters:true, 
      ...
      { id: 82,
        title: 'Spiders',
        text: 'Giant spider webs are easily concealed amongst the thick Chultan jungle.  Any character with passive perception 13 or higher spots the webs and alerts the party of 1d6 giant spiders.  Otherwise the lead party member is grappled and the spiders receive a suprise round.  Hundreds of harmless baby spdiers pour through the jungle as well.',
        monsters:true, 
            name:"Giant Spider",
            rolls:1,
            die:6,
      ...
      { id: 83,
        ...
        text: 'Any character with a passive perception of 12 or higher spots a 10 ft tall statue overgrown with vines.  The statue depicts an Idolized Chultan king, a represntation of Ubtao.  Roll a d4 to determine what is speciakl about the statue.  1: Treasure lies at the foot of th statue, Roll once on the treasure drop.  If no treasure the characters find worthelss bone jewlery instead. 2: Goblin, grun, and su- monster skulls are piled around the statue, 3:A glyph of warding is insceribed on the satute, to identify the glyph a character must succed ona  a DC 15 invesitgation check.  Any creature who touches the statue releases 20ft sphere showckwave dealing 5d8 thunder damage or half with a dc 15 dex save.  The niose has a 75% chance of attracting a nearby troll. 4: The statue has small grooves carved into it.  Any character with a dc10  Int check sees the way through the labyrinth.  Any player who traces the path with a finger gains the ability to cast Find The Pat with no components once.  The statue may grant this effect once a day at dawn ',
        monsters:true, 
            name:"Sea Hag",
            rolls:0,
            die:0,
      ...
      { id: 87,
        title: 'Su-monster',
        text: 'The party comes across 1d4+1 su-monsters (monkey demons) The su-monsters approach cautiously feigning curiosity.  If allowed to get close, the su-monsters all attempt to use a pyschic crush to stun the party before finishing them off.  The su-monsters have treasure stashed in their tree.  Roll on the treasure table once after combat.',
        monsters:true, 
            name:"Su-monster",
            rolls:1,
            die:4,
      ...
      { id: 89,
        ...
        text: 'The party is beset uppon by  1d4 swarm of insects.  Any character damaged in combat must suceed ina  DC 11 con check or contract shivering sickness',
        monsters:true, 
      ...
      { id: 91,
        title: 'Tiger',
        text: 'A tiger lays in wait.  Any player with passive perception of 16 or higher spots the tiger, else it pounces onm any player within 40 feet.  The tiger retreats if its health drops below half',
        monsters:true, 
            name:"Tiger",
            rolls:0,
            die:0,
      ...
      { id: 93,
        title: 'Vegepygmies',
        text: 'The character come upon 1d4 vegepygmies each mounted on a thorny.  These hunters have strayed far form home.  They flee if they re outnumbered.  Otherwise they attack ',
        monsters:true, 
            name:"Vegepymgie",
            rolls:1,
            die:4,
      ...
      { id: 94,
        title: 'Wereboar',
        text: 'A wereboar masquerading a s a chultan priest takes a dim view of the party and demands that the characters turn back. Around its neck is a wooden shymbol of Ubtao - a labyrnathine pendant.  The wereboar may be guarding a shrine of Ubtao, rare plants, or a treasure horde (three times on treasure roll)',
        monsters:true, 
            name:"Wereboar",
            rolls:0,
            die:0,
      ...
      { id: 95,
        title: 'Weretiger',
        text: 'A weretiger in human form offers to escort the players through the jungle.  For the next 24 hours nothing will attak them.  It leaves after 24 hours or until it reaches Omu, Nangalore, or Orolunga which it does not wish to explore.',
        monsters:true, 
            name:"Wewretiger",
            rolls:1,
            die:4,
      ...
      { id: 96,
        title: 'Winterscape',
        text: 'The characters come acrossa  120-ft radius sphere of pure winter weather created by Artus Climber and the Ring of Winter to fend off enemies.  The weather is magicly created and cannot be dispelled.  It is a bitin -30 farenheit in the sphere.',
        monsters:false, 
            name:"Winterscape",
            rolls:0,
            die:0,
      ...
      { id: 98,
        title: 'Yaun-ti',
        text: 'Yaun-ti patrols consist of 1d6+1 yuan-ti purebloods, which keep their distance as they try to gather information to take back to Ras Nsi.  The yuan-ti are camouflaged but any character with a dc 13 percetion check made with disadvantage spots the phony disguise.  If within 25 miels of Omu the yuan-ti are malisons and the check DC is 14.',
        monsters:true, 
            name:"Yuan-ti",
            rolls:1,
            die:4,
      ...
      { id: 99,
        title: 'Zhentarim',
        text: 'A Zhent assassin with a flying snake et leads a priest 2d6 thugs and 1d6 tribal warriors through the wilderness in search of Aruts Climber and the Ring of Winter.  If  Artus is with the characters the Zhents demand the ring and attack if they dont recieve it quickly.  Otherwise they show little interest in the characters.  Roll once on the treasure table to see what if any treasure they carry. ',
      ...
      { id: 100,
        title: 'Zorbos',
        text: 'If his encounter happens in the wild the party stumbles upon 2d6 Zorbos (panda bear demons) in wukka trees.  The creatures growl and bare their teeth in any players approach them.  If the characters act in a  threatening manor the zorbos attack.  If the encounter happens when the party is camped, the Zorbos drop from their trees and attack.' ,
        monsters:true, 
            name:"Tri-flower frond",
            rolls:1,
            die:4,
